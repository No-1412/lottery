...
public class Role extends IdEntity<Role> {
	...
	private List<com.youge.yogee.modules.sys.entity.Menu> menuList = Lists.newArrayList(); // 拥有菜单列表
	...
	@NotFound(action = NotFoundAction.IGNORE)
	@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
	public List<com.youge.yogee.modules.sys.entity.Menu> getMenuList() {
		return menuList;
	}

	public void setMenuList(List<com.youge.yogee.modules.sys.entity.Menu> menuList) {
	...
	public List<String> getMenuIdList() {
		...
		for (com.youge.yogee.modules.sys.entity.Menu menu : menuList) {
	...
	public void setMenuIdList(List<String> menuIdList) {
		...
		for (String menuId : menuIdList) {
			com.youge.yogee.modules.sys.entity.Menu menu = new com.youge.yogee.modules.sys.entity.Menu();
			menu.setId(menuId);
			menuList.add(menu);
		}
	}
