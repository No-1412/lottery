 ...
 */
@Entity
@Table(name = "cd_five_awards")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class CdFiveAwards extends BaseEntity<T> implements Serializable {
	...
	//@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_cd_five_awards")
	//@SequenceGenerator(name = "seq_cd_five_awards", sequenceName = "seq_cd_five_awards")
	public String getId() {
		return id;
	}
