 ...
 */
@Entity
@Table(name = "cd_choose_nine")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class CdChooseNine extends BaseEntity<T> implements Serializable {
	...
	//@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_cd_choose_nine")
	//@SequenceGenerator(name = "seq_cd_choose_nine", sequenceName = "seq_cd_choose_nine")
	public String getId() {
		return id;
	}
