 ...
 */
package com.youge.yogee.modules.cfootballdouble.entity;
 ...
 */
@Entity
@Table(name = "cd_football_double")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class CdFootBallDouble extends BaseEntity<T> implements Serializable {
	...
	public CdFootBallDouble() {
		super();
	}

	public CdFootBallDouble(String id){
		this();
		this.id = id;
	}
	...
	//@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_cd_football_double")
	//@SequenceGenerator(name = "seq_cd_football_double", sequenceName = "seq_cd_football_double")
	public String getId() {
		return id;
	}
