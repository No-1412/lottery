 ...
 */
package com.youge.yogee.modules.cfootballgoalresult.entity;
 ...
 */
@Entity
@Table(name = "cd_football_goalresult")
@Cache(usage = CacheConcurrencyStrategy.READ_WRITE)
public class CdFootballGoalResult extends BaseEntity<T> implements Serializable {
	...
	public CdFootballGoalResult() {
		super();
	}

	public CdFootballGoalResult(String id){
		this();
		this.id = id;
	}
	...
	//@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_cd_football_goalresult")
	//@SequenceGenerator(name = "seq_cd_football_goalresult", sequenceName = "seq_cd_football_goalresult")
	public String getId() {
		return id;
	}
