...
public class ArticleData extends BaseEntity<ArticleData> {
	...
	private com.youge.yogee.modules.cms.entity.Article article;
...
//	@OneToOne(mappedBy="articleData",cascade=CascadeType.ALL)
	...
	public com.youge.yogee.modules.cms.entity.Article getArticle() {
		return article;
	}

	public void setArticle(com.youge.yogee.modules.cms.entity.Article article) {
