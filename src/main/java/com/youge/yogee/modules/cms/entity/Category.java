 ...
 */
package com.youge.yogee.modules.cms.entity;
...
public class Category extends IdEntity<Category> {
	...
	private com.youge.yogee.modules.cms.entity.Site site;		// 归属站点
	...
	public Category(String id, com.youge.yogee.modules.cms.entity.Site site){
		this();
		this.id = id;
		this.setSite(site);
	}
	...
	public com.youge.yogee.modules.cms.entity.Site getSite() {
		return site;
	}

	public void setSite(com.youge.yogee.modules.cms.entity.Site site) {
		this.site = site;
	}
