 ...
 */
package com.youge.yogee.common.persistence;

import com.youge.yogee.common.utils.Reflections;
...
public class BaseDao<T> {
	 ...
	 * @return
	 */
	public <E> com.youge.yogee.common.persistence.Page<E> find(com.youge.yogee.common.persistence.Page<E> page, String qlString){
	...
	public <E> com.youge.yogee.common.persistence.Page<E> find(com.youge.yogee.common.persistence.Page<E> page, String qlString, Parameter parameter){
		// get count
...
//	        page.setCount(Long.valueOf(createQuery(countQlString, parameter).uniqueResult().toString()));
	 ...
	 * @return
	 */
	public <E> com.youge.yogee.common.persistence.Page<E> findBySql(com.youge.yogee.common.persistence.Page<E> page, String sqlString){
	 ...
	 * @return
	 */
	public <E> com.youge.yogee.common.persistence.Page<E> findBySql(com.youge.yogee.common.persistence.Page<E> page, String sqlString, Parameter parameter){
	 ...
	 * @return
	 */
	public <E> com.youge.yogee.common.persistence.Page<E> findBySql(com.youge.yogee.common.persistence.Page<E> page, String sqlString, Class<?> resultClass){
	 ...
	 */
    @SuppressWarnings("unchecked")
	public <E> com.youge.yogee.common.persistence.Page<E> findBySql(com.youge.yogee.common.persistence.Page<E> page, String sqlString, Parameter parameter, Class<?> resultClass){
		// get count
    	if (!page.isDisabled() && !page.isNotCount()){
...
//	        page.setCount(Long.valueOf(createSqlQuery(countSqlString, parameter).uniqueResult().toString()));
	 ...
	 * @return
	 */
	public com.youge.yogee.common.persistence.Page<T> find(com.youge.yogee.common.persistence.Page<T> page) {
	 ...
	 * @return
	 */
	public com.youge.yogee.common.persistence.Page<T> find(com.youge.yogee.common.persistence.Page<T> page, DetachedCriteria detachedCriteria) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public com.youge.yogee.common.persistence.Page<T> find(com.youge.yogee.common.persistence.Page<T> page, DetachedCriteria detachedCriteria, ResultTransformer resultTransformer) {
		// get count
		if (!page.isDisabled() && !page.isNotCount()){
	 ...
	 */
	@SuppressWarnings("unchecked")
	public com.youge.yogee.common.persistence.Page<T> search(com.youge.yogee.common.persistence.Page<T> page, BooleanQuery query, BooleanQuery queryFilter, Sort sort){
