...
public class FreeMarkers {
	...
	public static String renderString(String templateString, Map<String, ?> model) {
		try {
			...
			throw com.youge.yogee.common.utils.Exceptions.unchecked(e);
		}
	}
...
//		Template yogee = cfg.getTemplate("testTemplate.ftl");
//		String result2 = FreeMarkers.renderTemplate(yogee, model);
