...
public class LotteryUtil {
    ...
    public static BigDecimal BestWinningVerify(List<String> list, Map<String, CdFootballAwards> resultMap, String followNum, String times, String acount) {
    ...
    public static BigDecimal WinningVerify(List<String> list, Map<String, CdFootballAwards> resultMap, String followNum, String times, String acount) {
        //System.out.println(list);
        List<String> index = new ArrayList<String>();
        JSONObject sJson = new JSONObject();// 存储购买比赛信息
        int bileCount = 0;
    ...
    private static String ConvertInt(String s1) {
        if (s1.equals("主胜") || s1.equals("让主胜")) {
            return "3";
        }
        if (s1.equals("主负") || s1.equals("让主负")) {
            return "0";
        }
        if (s1.equals("平")) {
            return "1";
        }
        return s1.replaceAll("胜", "3").replaceAll("负", "0").replaceAll("平", "1");
    }
