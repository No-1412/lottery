...
/**
 * Created by liyuan on 2018/3/27.
 */
public class BankUtil {
    ...
    public static Boolean bankVerify(String bankcard,String idcard,String mobile,String name){
        String host = "https://bankcard4.shumaidata.com";
        String path = "/bank_card4/verify";
        String method = "POST";
