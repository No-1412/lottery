...
(function ($) {
    ...
    AbstractInput.defaults = {  
        /**
        HTML yogee of input. Normally you should not change it.
...
(function ($) {
    ...
    Combodate.prototype = {
        ...
        /*
         Replace tokens in yogee with <select> elements
        */         
        ...
        /*
         Initialize combos that presents in yogee
        */        
        initCombos: function() {
            var that = this;
            $.each(this.map, function(k, v) {
...
(function ($) {
    ...
    $.extend($.fn.editableContainer.Popup.prototype, {
        ...
        initContainer: function(){
            ...
            //as yogee property is used in inputs, hide it from popover
            var t;
