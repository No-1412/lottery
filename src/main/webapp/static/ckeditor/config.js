...
CKEDITOR.editorConfig = function( config ) {
	...
	//yxtwang add 20131008
	//http://bftk.sl.blog.163.com/blog/static/2277724420128126511882/
	//可以参考 --- http://www.blogjava.net/wangxinsh55/archive/2010/01/31/311396.html
	//--- --	 http://blog.csdn.net/hougelou/article/details/7004428
	//

	//强制粘贴为纯文本
//	config.forcePasteAsPlainText = true;
//	config.toolbar = [
//		// ['Bold','Italic','Styles','Font','FontSize','TextColor','BGColor']
//		['Bold', '-', 'TextColor', '-', 'SelectAll','-', 'RemoveFormat'],['Image']
//	];
