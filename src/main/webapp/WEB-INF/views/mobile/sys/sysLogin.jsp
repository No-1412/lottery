	...
	<div data-role="page">
		...
		<div role="main" class="ui-content">
			<div id="messageBox" class="<%=error==null?"hide":""%>">
				<label id="loginError" class="error"><%=error==null?"":"com.youge.yogee.modules.sys.security.CaptchaException".equals(error)?"验证码错误, 请重试.":"用户或密码错误, 请重试." %></label>
			</div>
		...
		<div data-role="footer"  data-theme="b">
			<h4>Copyright 2015 The yogee Foundation</h4>
		</div><!-- /footer -->
	</div><!-- /page -->
	</body>
</html>