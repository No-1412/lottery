...
<head>
  ...
  <style>
    *{padding:0;margin:0;}
    body{width:79.16mm;height:220.47mm;position: relative;}
    ...
    #match1 table,#match2 table,#match3 table,#match4 table,#match5 table,#match6 table,#match7 table,#match8 table,.pass_method table,.multiple_table{
      border-right:1px solid transparent;
      border-bottom:1px solid transparent;
      border-collapse: collapse;
      border-spacing: 0;
    ...
    #match1 table td,#match2 table td,#match3 table td,#match4 table td,#match5 table td,#match6 table td,#match7 table td,#match8 table td,.pass_method table td,.multiple_table td{
      width:5.1mm;
      height:5.025mm;
    }
    #match1 table td p,#match2 table td p,#match3 table td p,#match4 table td p,#match5 table td p,#match6 table td p,#match7 table td p,#match8 table td p,.pass_method table td p,.multiple_table td p{
      margin: 1.9125mm 0.8mm;
      width:3.5mm;
      height:1.2mm;
    }
    .rBottom{
    ...
    /*结束标识*/
    .over_tip{width:3.7mm;height:2mm;background: #000;position: absolute;bottom:8.5mm;right:0.5mm;}
    /*左边的黑点*/
...
<div id="print" >打印</div>
<!--startprint-->
<div style="height:12mm"><p>${orderNumber}</p><p>${returnStr}</p></div>
...
<script>
  ...
  var optionNumber = "1010101011000110";
</script>
