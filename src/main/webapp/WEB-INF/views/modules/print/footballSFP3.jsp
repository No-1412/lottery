...
<head>
  ...
  <style>
    *{padding:0;margin:0;}
    body{width:79.16mm;height:114.38mm;position: relative;}
    ...
    /*结束标识*/
    .over_tip{width:3.7mm;height:2mm;background: #000;position: absolute;bottom:16.9mm;right:0.5mm;}
    /*左边的黑点*/
  ...
  <script type="text/javascript" src="${ctxStatic}/printjianrong.js"></script>

</head>
<body>
<div id="print" >打印</div>
<!--startprint-->
<div style="height:20.6mm"><p>${orderNumber}</p><p>${returnStr}</p></div>
