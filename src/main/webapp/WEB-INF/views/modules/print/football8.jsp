...
<head>
  ...
  <style>
    *{padding:0;margin:0;}
    body{width:79.16mm;height:211.41mm;position: relative;}
    ...
    /*结束标识*/
    .over_tip{width:3.7mm;height:2mm;background: #000;position: absolute;bottom:15mm;right:0.5mm;}
    /*左边的黑点*/
...
<script>
  ...
  var optionNumber = "1010101110000101";
</script>
