...
<head>
  ...
  <style>
    *{padding:0;margin:0;}
    body{width:79.16mm;height:174.5mm;position: relative;}
  ...
  <div class="rBOx">
    ...
    <div class="rContent">
      ...
      <div id="match1">
        ...
        <!-- 半全场 -->
        <table class="half_table" cellspacing="0" cellpadding="0" style='width:100%;text-align:center;'>
          <tr>
            <td><p></p></td>
            <td><p></p></td>
            <td><p></p></td>
        ...
        <!-- 总进球 -->
        <table class="total_table" cellspacing="0" cellpadding="0" style='width:100%;text-align:center;'>
          <tr>
            <td><p></p></td>
            <td><p></p></td>
            <td><p></p></td>
...
<script>
  ...
  var optionNumber = "1010101101111000";
</script>
