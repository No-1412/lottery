...
<head>
  ...
  <style>
    *{padding:0;margin:0;}
    body{width:79.16mm;height:140.38mm;position: relative;}
    ...
    /*结束标识*/
    .over_tip{width:3.7mm;height:2mm;background: #000;position: absolute;bottom:10mm;right:1.2mm;}
    /*左边的黑点*/
...
<div id="print" >打印</div>
<!--startprint-->
<div style="height:12.5mm"><p>${orderNumber}</p><p>${returnStr}</p></div>
  ...
  <div class="rBOx">
    ...
    <div class="rContent">
      ...
      <div id="match1">
        ...
        <!-- 胜分差 -->
        <div class="match_title"></div>
        <div style='width:21.4mm;float:left;'>
          <!-- 客胜 -->
          <table class="guest_table" cellspacing="0" cellpadding="0" style='width:9.5mm;text-align:center;float:left;border-width:0;'>
            <tr>
              <td><p></p></td>
              <td><p></p></td>
            </tr>
          ...
          <!-- 主胜 -->
          <table class="host_table" cellspacing="0" cellpadding="0" style='width:9.5mm;text-align:center;float:right;border-width:0;'>
            <tr>
              <td><p></p></td>
              <td><p></p></td>
            </tr>
        ...
        <!-- 胜负 -->
        <table class="outcome_table" cellspacing="0" cellpadding="0" style='width:100%;text-align:center;border-top:1px solid transparent;'>
          <tr>
            <td><p></p></td>
            <td><p></p></td>
            <td><p></p></td>
      ...
      <div id="match3">
        ...
        <!-- 胜分差 -->
        <div class="match_title"></div>
        <div style='width:21.4mm;overflow:hidden;'>
          <!-- 客胜 -->
          <table class="guest_table" cellspacing="0" cellpadding="0" style='width:9.5mm;text-align:center;float:left;border-width:0;'>
            <tr>
              <td><p></p></td>
...
<script>
  ...
  var optionNumber = "1010101011010010";
</script>
