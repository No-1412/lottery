...
<ul class="nav nav-tabs">
    <li>
        <a href="${ctx}/cthreeawards/cdThreeOrder/">排列三订单列表</a>
    </li>
    <li class="active">
        <a href="${ctx}/cthreeawards/cdThreeOrder/form?id=${cdThreeOrder.id}">排列三订单<shiro:hasPermission
                name="cthreeawards:cdThreeOrder:edit">${not empty cdThreeOrder.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission
                name="cthreeawards:cdThreeOrder:edit">查看</shiro:lacksPermission></a>
    </li>
</ul>
<br/>
<form:form id="inputForm" modelAttribute="cdThreeOrder" action="${ctx}/cthreeawards/cdThreeOrder/save" method="post"
    ...
    <div class="control-group">
        ...
        <div class="controls">
                <%--<form:input path="uid" htmlEscape="false" maxlength="200" class="required" readonly="true"/>--%>
            <input type="text" readonly="readonly" value="${buyWaysStr}">
        </div>
    </div>
