...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			$.backstretch([
				"${ctxStatic}/images/banner-01.jpg",
				"${ctxStatic}/images/banner-02.jpg",
				"${ctxStatic}/images/banner-03.jpg",
				"${ctxStatic}/images/banner-04.jpg"
...
<div class="navbar navbar-fixed-top">
	<div class="navbar-inner div-alpha">
		<div class="container">
			<a href="${ctx}"><img src="${ctxStatic}/images/headlogo.png" alt="彩票开发模板" style="height:80px;"></a>
		</div>
	</div>
</div>
...
<div class="container">
	...
	<div id="messageBox" class="alert alert-error <%=error==null?"hide":""%>"><button data-dismiss="alert" class="close">×</button>
		<label id="loginError" class="error"><%=error==null?"":"com.templateba.business.modules.sys.security.CaptchaException".equals(error)?"验证码错误, 请重试.":"用户或密码错误, 请重试." %></label>
	</div>
	<div id="login-wraper">
		<form id="loginForm"  class="form login-form" action="${ctx}/login" method="post">
			<legend><span style="color:#32CD32;">后台登陆</span></legend>
			<div class="body">
...
<footer class="white navbar-fixed-bottom div-alpha">
	<a href="http://templateba.cn">YG模板 v1.0</a>
</footer>
</body>
</html>