...
<body>
	<ul class="nav nav-tabs">
		<li>
			<a href="${ctx}/erp/erpRechargeLog/withholdList">销售后台充值记录列表</a>
		</li>
		<li class="active">
	...
	<form:form id="inputForm" modelAttribute="erpRechargeLog" action="${ctx}/erp/erpRechargeLog/save?type=1" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="erp:erpRechargeLog:edit">
				<input id="btnSubmit" class="btn btn-primary" type="submit" value="扣 款"/>&nbsp;
			</shiro:hasPermission>
