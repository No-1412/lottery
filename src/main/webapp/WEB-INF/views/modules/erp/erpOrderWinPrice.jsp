...
<form:form id="inputForm" modelAttribute="erpOrder" action="${ctx}/erp/erpOrder/addAward" method="post" class="form-horizontal">
    <form:hidden path="id"/>
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <form:input path="winPrice" htmlEscape="false" maxlength="200" class="required"/>
        </div>
    </div>
