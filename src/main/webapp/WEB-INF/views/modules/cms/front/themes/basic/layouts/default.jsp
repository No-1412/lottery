...
<html>
<head>
	<title><sitemesh:title default="欢迎光临"/> 梦客</title>
      ...
      <div class="navbar-inner">
        <div class="container">
          <c:choose>
   			...
   			<c:otherwise><a class="brand" href="${ctx}/index-${site.id}${fns:getUrlSuffix()}">夺宝奇兵</a></c:otherwise>
   		  </c:choose>
         ...
         <%-- <div class="nav-collapse">
           ...
           &lt;%&ndash; <form class="navbar-form pull-right" action="${ctx}/search" method="get">
