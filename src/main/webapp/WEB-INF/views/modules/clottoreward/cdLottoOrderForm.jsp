...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active">
			<a href="${ctx}/clottoreward/cdLottoOrder/form?id=${cdLottoOrder.id}">大乐透订单<shiro:hasPermission name="clottoreward:cdLottoOrder:edit">${not empty cdLottoOrder.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="clottoreward:cdLottoOrder:edit">查看</shiro:lacksPermission></a>
		</li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="cdLottoOrder" action="${ctx}/clottoreward/cdLottoOrder/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<tags:message content="${message}"/>
		<div class="control-group">
			<label class="control-label">订单号:</label>
			<div class="controls">
				<form:input path="orderNum" htmlEscape="false" maxlength="200" class="required"/>
			</div>
		</div>
		<div class="control-group">
