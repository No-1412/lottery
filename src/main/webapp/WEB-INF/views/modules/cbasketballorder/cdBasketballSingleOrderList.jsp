...
<body>
	...
	<form:form id="searchForm" modelAttribute="cdBasketballSingleOrder" action="${ctx}/cbasketballorder/cdBasketballSingleOrder/" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		<thead>
			<tr>
				...
				<th>下单时间</th>
				<th>订单状态</th>
				<shiro:hasPermission name="cbasketballorder:cdBasketballSingleOrder:edit"><th>操作</th></shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="cdBasketballSingleOrder">
			<tr>
				<td><a href="${ctx}/cbasketballorder/cdBasketballSingleOrder/form?id=${cdBasketballSingleOrder.id}">${cdBasketballSingleOrder.orderNum}</a></td>
				<td>
					<c:choose>
				...
				<td>${cdBasketballSingleOrder.uid}</td>
				...
				<shiro:hasPermission name="cbasketballorder:cdBasketballSingleOrder:edit">
					<td>
						...
						<a href="${ctx}/cbasketballorder/cdBasketballSingleOrder/delete?id=${cdBasketballSingleOrder.id}" onclick="return confirmx('确认要删除该竞彩篮球订单吗？', this.href)">删除</a>
					</td>
				</shiro:hasPermission>
			</tr>
		</c:forEach>
