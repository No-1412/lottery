...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active">
			<a href="${ctx}/cbasketballorder/cdBasketballSingleOrder/form?id=${cdBasketballSingleOrder.id}">竞彩篮球订单<shiro:hasPermission name="cbasketballorder:cdBasketballSingleOrder:edit">${not empty cdBasketballSingleOrder.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="cbasketballorder:cdBasketballSingleOrder:edit">查看</shiro:lacksPermission></a>
		</li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="cdBasketballSingleOrder" action="${ctx}/cbasketballorder/cdBasketballSingleOrder/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
