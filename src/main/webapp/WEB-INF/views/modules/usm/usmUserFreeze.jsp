...
<%--<ul class="nav nav-tabs">--%>
  ...
  <%--</li>--%>
  <%--<li class="active">--%>
    <%--<a href="${ctx}/usm/usmUser/form?id=${usmUser.id}">用户表<shiro:hasPermission name="usm:usmUser:edit">${not empty usmUser.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="usm:usmUser:edit">查看</shiro:lacksPermission></a>--%>
  <%--</li>--%>
<%--</ul><br/>--%>
<%--<form:form id="inputForm" modelAttribute="usmUser" action="${ctx}/usm/usmUser/save" method="post" class="form-horizontal">--%>
  ...
  <%--<div class="control-group">--%>
    ...
    <%--<div class="controls">--%>
      <%--<form:select path="freeze" items="${fns:getDictList('no_yes')}" itemLabel="label" itemValue="value" />--%>
    <%--</div>--%>
  <%--</div>--%>
  <%--<div class="control-group">--%>
